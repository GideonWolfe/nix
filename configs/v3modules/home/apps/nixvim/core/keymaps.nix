{
  programs.nixvim.keymaps = [
    ...
    # Git
    {
      ...
      key = "<leader>gg";
      mode = [ "n" ];
      options = { desc = "Git GUI"; };
    }
    {
      action = "<cmd>silent Git add %<CR>";
      key = "<leader>ga";
      mode = [ "n" ];
      options = { desc = "Git Add File"; };
    }
    {
    ...
    }
    {
      ...
      key = "<leader>ci";
      mode = [ "n" ];
      options = { desc = "Code Implementations"; };
    }
    {
      action = "<cmd>TodoTelescope<CR>";
      key = "<leader>cT";
      mode = [ "n" ];
      options = { desc = "Code Todos Telescope"; };
    }
    {
      action = "<cmd>TodoTrouble<CR>";
      key = "<leader>ct";
      mode = [ "n" ];
      options = { desc = "Code Todos Trouble"; };
    }
    {
    ...
    }
    {
      ...
      key = "<leader>fvh";
      mode = [ "n" ];
      options = { desc = "Find Vim Help"; };
    }
    {
      action = "<cmd>Telescope commands<CR>";
      key = "<leader>fvc";
      mode = [ "n" ];
      options = { desc = "Find Vim Commands"; };
    }
    {
      action = "<cmd>Telescope keymaps<CR>";
      key = "<leader>fvk";
      mode = [ "n" ];
      options = { desc = "Find Vim Keymaps"; };
    }
    {
    ...
    }
    {
      ...
      key = "<leader>fws";
      mode = [ "n" ];
      options = { desc = "Find Workspace Symbols"; };
    }
