...
{
  xdg.configFile.obs-stylix-theme-def = {
    enable = true;
    ...
    text = ''
      ...
      @OBSThemeVars {
          ...
          --ctp_mantle: ${base01};
          --ctp_crust: ${base02};
          --ctp_selection_background: ${base04};
      }

      VolumeMeter {
          qproperty-foregroundNominalColor: var(--ctp_green);
          qproperty-foregroundWarningColor: var(--ctp_orange);
  ...
  xdg.configFile.obs-stylix-theme-spec = {
    enable = true;
    target = "obs-studio/themes/stylix.obt";
    text = ''
      @OBSThemeMeta {
          name: 'Stylix';
