...
#target = "test/obsidian/.obsidian/snippets/obsidian-stylix-css.css";
    ...
    text = ''
        :root {
            ...
            --bright-pink_x:    ${base06-rgb-r},${base06-rgb-g},${base06-rgb-b}; 
            ...
            --neutral-pink_x:   ${base06-rgb-r},${base06-rgb-g},${base06-rgb-b}; 
            ...
            --faded-pink_x:     ${base06-rgb-r},${base06-rgb-g},${base06-rgb-b}; 
