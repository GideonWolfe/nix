...
#search_options[nixpkgs]="https://search.nixos.org/packages?channel=24.11&type=packages&query="
#search_options[nixopts]="https://search.nixos.org/options?channel=24.11&query="
#search_options[home-manager]="https://home-manager-options.extranix.com/?query="
search_options[nix]="https://searchix.alanpearce.eu/?query="
# Development
